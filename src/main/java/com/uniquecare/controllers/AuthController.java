...
import com.uniquecare.payload.response.JwtResponse;
import com.uniquecare.payload.response.MessageResponse;
import com.uniquecare.security.jwt.JwtUtils;
            ...
            strRoles.forEach(role -> {
                switch (role) {
                    case "admin":
                        ...
                        break;
                    case "facility":
                        Role facilityRole = roleService.findByName(ERole.ROLE_FACILITY)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
